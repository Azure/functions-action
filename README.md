...
**NOTE:** If you are using a Custom handler with the Linux consumption SKU, this deployment process _will not work_ . You must use a Service Principal and authenticate with the `azure/login` action.
