...
class Kudu {
    ...
    updateAppSettingViaKudu(appSettings_1) {
        return __awaiter(this, arguments, void 0, function* (appSettings, retryCount = 1, retryIntervalSecond = 5, throwOnError = true) {
            let httpRequest = {
                method: 'POST',
                uri: this._client.getRequestUri(`/api/settings`),
    ...
    deleteAppSettingViaKudu(appSetting_1) {
        return __awaiter(this, arguments, void 0, function* (appSetting, retryCount = 1, retryIntervalSecond = 5, throwOnError = true) {
            const httpRequest = {
                method: 'DELETE',
