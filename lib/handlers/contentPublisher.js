        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (context.publishMethod) {
                ...
                case publish_method_1.PublishMethodConstant.WebsiteRunFromPackageDeploy:
                    ...
                    break;
                case publish_method_1.PublishMethodConstant.OneDeployFlex:
                    yield publishers_1.OneDeployFlex.execute(state, context, params.remoteBuild);
                    break;
                default:
                    throw new exceptions_1.ValidationError(state, "publisher", "can only performs ZipDeploy or WebsiteRunFromPackageDeploy or OneDeploy (for Flex Consumption plan only)");
            }
