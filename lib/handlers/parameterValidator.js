...
class ParameterValidator {
    ...
    invoke(state) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sku = core.getInput(configuration_1.ConfigurationConstant.ParamInSku);
            this._remoteBuild = core.getInput(configuration_1.ConfigurationConstant.ParamInRemoteBuild);
            // Validate field
    ...
    changeParams(_0, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            params.remoteBuild = parser_1.Parser.IsTrueLike(this._remoteBuild);
            return params;
        });
    }
