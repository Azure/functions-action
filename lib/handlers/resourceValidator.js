...
class ResourceValidator {
    ...
    getDetailsByScm(state, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._kuduServiceUtil = new KuduServiceUtility_1.KuduServiceUtility(this._kuduService);
            //Kudu API (GET {publishURL}/api/settings api is not available for kubernetes apps
    ...
    getFunctionappSettingsScm(state, kuduService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.Logger.Info('Sucessfully acquired app settings from function app (with SCM credential)!');
