...
const azure_app_service_1 = require("../appservice-rest/Arm/azure-app-service");
const AzureAppServiceUtility_1 = require("../appservice-rest/Utilities/AzureAppServiceUtility");
...
const azure_app_kudu_service_1 = require("../appservice-rest/Kudu/azure-app-kudu-service");
const KuduServiceUtility_1 = require("../appservice-rest/Utilities/KuduServiceUtility");
...
class ResourceValidator {
    ...
    getDetailsByRbac(state, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._appServiceUtil = new AzureAppServiceUtility_1.AzureAppServiceUtility(this._appService, this._endpoint);
    ...
    getFunctionappSku(state, appService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.Logger.Info('Successfully acquired site configs from function app!');
    ...
    getFunctionappSettingsRbac(state, appService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new exceptions_1.AzureResourceError(state, 'Get Function App Settings', 'Failed to acquire app settings from Azure Resource Manager (RBAC credential).', expt);
            }
            if (appSettings === undefined || appSettings.properties === undefined) {
                throw new exceptions_1.AzureResourceError(state, 'Get Function App Settings', 'Function app settings should not be empty (fetched from Azure Resource Manager with RBAC credential).');
            }
            if (!appSettings.properties['AzureWebJobsStorage'] && !appSettings.properties['AzureWebJobsStorage__accountName']) {
                utils_1.Logger.Warn('Neither AzureWebJobsStorage nor AzureWebJobsStorage__accountName exist in app settings (from Azure Resource Manager with RBAC credential). ' +
            ...
            utils_1.Logger.Info('Successfully acquired app settings from function app (RBAC)!');
    ...
    getFunctionappSettingsScm(state, kuduService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new exceptions_1.AzureResourceError(state, 'Get Function App Settings', 'Failed to acquire app settings from https://<scmsite>/api/settings with publish-profile', expt);
            }
            if (appSettings === undefined) {
                throw new exceptions_1.AzureResourceError(state, 'Get Function App Settings', 'Function app settings should not be empty (fetched from Kudu SCM site with publish-profile credential).');
            }
            if (!appSettings['AzureWebJobsStorage'] && !appSettings['AzureWebJobsStorage__accountName']) {
                utils_1.Logger.Warn('Neither AzureWebJobsStorage nor AzureWebJobsStorage__accountName exist in app settings (from Kudu SCM site with publish-profile credential). ' +
                    'Please ensure one of them is configured as it is critical for function runtime. ' +
                    'For more information, please visit the function app settings reference page: ' +
                    'https://docs.microsoft.com/en-us/azure/azure-functions/functions-app-settings#azurewebjobsstorage');
            }
            ...
            utils_1.Logger.Info('Successfully acquired app settings from function app (with SCM credential)!');
