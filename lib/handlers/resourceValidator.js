...
class ResourceValidator {
    invoke(state, params) {
        return __awaiter(this, void 0, void 0, function* () {
            const appNameWithSlot = this.getAppNameWithSlot(params.appName, params.slot);
            this._endpoint = AuthorizationHandlerFactory_1.getHandler();
            yield this.getResourceDetails(state, this._endpoint, appNameWithSlot);
            this._appService = new azure_app_service_1.AzureAppService(this._endpoint, this._resourceGroupName, appNameWithSlot);
    ...
    getAppNameWithSlot(appName, slotName) {
        if (slotName) {
