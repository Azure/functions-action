...
class WebsiteRunFromPackageDeploy {
    static execute(state, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.publishToFunctionapp(state, context.appService, context.appUrl, `${blobUrl.url}?${blobSasParams}`);
        });
    }
    ...
    static publishToFunctionapp(state, appService, appUrl, blobSasUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
            ...
            yield this.waitForSpinUp(state, appUrl);
            try {
