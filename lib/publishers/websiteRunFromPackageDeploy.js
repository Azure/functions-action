...
class WebsiteRunFromPackageDeploy {
    static execute(state, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.publishToFunctionapp(state, context.appService, context.appServiceUtil, `${blobUrl.url}?${blobSasParams}`);
        });
    }
    ...
    static publishToFunctionapp(state, appService, appServiceUtil, blobSasUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
            ...
            yield this.waitForSpinUp(state, appServiceUtil);
            try {
    ...
    static waitForSpinUp(state, appServiceUtil) {
        return __awaiter(this, void 0, void 0, function* () {
            utils_1.Logger.Log("Waiting for functino app to spin up after app settings change.");
            let spinnedUp = false;
            let retryCount = 10;
            let retryGapMs = 5000;
            while (retryCount > 0 && !spinnedUp) {
                utils_1.Sleeper.timeout(retryGapMs);
                try {
                    yield appServiceUtil.getWebDeployPublishingProfile();
                    spinnedUp = true;
                }
                catch (_a) {
                    retryCount--;
