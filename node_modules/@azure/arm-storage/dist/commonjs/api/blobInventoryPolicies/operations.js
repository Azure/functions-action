...
async function _listDeserialize(result) {
  ...
  return (0, import_models._listBlobInventoryPolicyDeserializer)(result.body);
}
...
function _$deleteSend(context, resourceGroupName, accountName, blobInventoryPolicyName, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
...
async function $delete(context, resourceGroupName, accountName, blobInventoryPolicyName, options = { requestOptions: {} }) {
...
function _createOrUpdateSend(context, resourceGroupName, accountName, blobInventoryPolicyName, properties, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/inventoryPolicies/{blobInventoryPolicyName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
  ...
  return context.path(path).put({
    ...
    headers: { accept: "application/json", ...options.requestOptions?.headers },
    body: (0, import_models.blobInventoryPolicySerializer)(properties)
  });
}
async function _createOrUpdateDeserialize(result) {
  ...
  return (0, import_models.blobInventoryPolicyDeserializer)(result.body);
}
async function createOrUpdate(context, resourceGroupName, accountName, blobInventoryPolicyName, properties, options = { requestOptions: {} }) {
...
function _getSend(context, resourceGroupName, accountName, blobInventoryPolicyName, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/inventoryPolicies/{blobInventoryPolicyName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
...
async function get(context, resourceGroupName, accountName, blobInventoryPolicyName, options = { requestOptions: {} }) {
