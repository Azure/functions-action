...
async function _listDeserialize(result) {
  ...
  return (0, import_models._deletedAccountListResultDeserializer)(result.body);
}
...
function _getSend(context, deletedAccountName, location, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
...
async function _getDeserialize(result) {
  ...
  return (0, import_models.deletedAccountDeserializer)(result.body);
}
async function get(context, deletedAccountName, location, options = { requestOptions: {} }) {
