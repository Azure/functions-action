...
__export(operations_exports, {
  ...
  _listSend: () => _listSend,
  _regeneratePasswordDeserialize: () => _regeneratePasswordDeserialize,
  _regeneratePasswordSend: () => _regeneratePasswordSend,
...
function _regeneratePasswordSend(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
...
async function _regeneratePasswordDeserialize(result) {
  ...
  return (0, import_models.localUserRegeneratePasswordResultDeserializer)(result.body);
}
async function regeneratePassword(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
...
function _listKeysSend(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
...
async function _listKeysDeserialize(result) {
  ...
  return (0, import_models.localUserKeysDeserializer)(result.body);
}
async function listKeys(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
...
function _listSend(context, resourceGroupName, accountName, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
...
async function _listDeserialize(result) {
  ...
  return (0, import_models._localUsersDeserializer)(result.body);
}
function list(context, resourceGroupName, accountName, options = { requestOptions: {} }) {
...
function _$deleteSend(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
...
async function $delete(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
  const result = await _$deleteSend(context, resourceGroupName, accountName, username, options);
  return _$deleteDeserialize(result);
}
function _createOrUpdateSend(context, resourceGroupName, accountName, username, properties, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/localUsers/{username}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
  ...
  return context.path(path).put({
    ...
    headers: { accept: "application/json", ...options.requestOptions?.headers },
    body: (0, import_models.localUserSerializer)(properties)
  });
}
async function _createOrUpdateDeserialize(result) {
  ...
  return (0, import_models.localUserDeserializer)(result.body);
}
async function createOrUpdate(context, resourceGroupName, accountName, username, properties, options = { requestOptions: {} }) {
...
function _getSend(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/localUsers/{username}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
...
async function get(context, resourceGroupName, accountName, username, options = { requestOptions: {} }) {
...
0 && (module.exports = {
  ...
  _listKeysSend,
  _listSend,
  _regeneratePasswordDeserialize,
  _regeneratePasswordSend,
  createOrUpdate,
  get,
  list,
  listKeys,
