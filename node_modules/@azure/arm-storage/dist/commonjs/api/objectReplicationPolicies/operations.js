...
async function _listDeserialize(result) {
  ...
  return (0, import_models._objectReplicationPoliciesDeserializer)(result.body);
}
...
function _$deleteSend(context, resourceGroupName, accountName, objectReplicationPolicyId, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
...
async function $delete(context, resourceGroupName, accountName, objectReplicationPolicyId, options = { requestOptions: {} }) {
...
function _createOrUpdateSend(context, resourceGroupName, accountName, objectReplicationPolicyId, properties, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/objectReplicationPolicies/{objectReplicationPolicyId}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
  ...
  return context.path(path).put({
    ...
    headers: { accept: "application/json", ...options.requestOptions?.headers },
    body: (0, import_models.objectReplicationPolicySerializer)(properties)
  });
}
async function _createOrUpdateDeserialize(result) {
  ...
  return (0, import_models.objectReplicationPolicyDeserializer)(result.body);
}
async function createOrUpdate(context, resourceGroupName, accountName, objectReplicationPolicyId, properties, options = { requestOptions: {} }) {
...
function _getSend(context, resourceGroupName, accountName, objectReplicationPolicyId, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/objectReplicationPolicies/{objectReplicationPolicyId}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
...
async function get(context, resourceGroupName, accountName, objectReplicationPolicyId, options = { requestOptions: {} }) {
