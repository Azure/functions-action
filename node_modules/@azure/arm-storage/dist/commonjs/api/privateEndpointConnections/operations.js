...
__export(operations_exports, {
  ...
  _listSend: () => _listSend,
  _putDeserialize: () => _putDeserialize,
  _putSend: () => _putSend,
  get: () => get,
  list: () => list,
  put: () => put
...
function _$deleteSend(context, resourceGroupName, accountName, privateEndpointConnectionName, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
...
async function $delete(context, resourceGroupName, accountName, privateEndpointConnectionName, options = { requestOptions: {} }) {
...
function _putSend(context, resourceGroupName, accountName, privateEndpointConnectionName, properties, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/privateEndpointConnections/{privateEndpointConnectionName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
  ...
  return context.path(path).put({
    ...
    headers: { accept: "application/json", ...options.requestOptions?.headers },
    body: (0, import_models.privateEndpointConnectionSerializer)(properties)
  });
}
async function _putDeserialize(result) {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = (0, import_core_client.createRestError)(result);
    if (result.body) {
...
async function put(context, resourceGroupName, accountName, privateEndpointConnectionName, properties, options = { requestOptions: {} }) {
...
function _getSend(context, resourceGroupName, accountName, privateEndpointConnectionName, options = { requestOptions: {} }) {
  const path = (0, import_urlTemplate.expandUrlTemplate)(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/privateEndpointConnections/{privateEndpointConnectionName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
...
async function get(context, resourceGroupName, accountName, privateEndpointConnectionName, options = { requestOptions: {} }) {
