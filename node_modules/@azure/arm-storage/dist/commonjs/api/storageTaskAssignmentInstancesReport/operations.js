...
function _listSend(context, resourceGroupName, accountName, storageTaskAssignmentName, options = { requestOptions: {} }) {
...
async function _listDeserialize(result) {
  ...
  return (0, import_models._storageTaskReportSummaryDeserializer)(result.body);
}
function list(context, resourceGroupName, accountName, storageTaskAssignmentName, options = { requestOptions: {} }) {
