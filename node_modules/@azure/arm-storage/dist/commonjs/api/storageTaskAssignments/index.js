...
var storageTaskAssignments_exports = {};
__export(storageTaskAssignments_exports, {
  $delete: () => import_operations.$delete,
  create: () => import_operations.create,
  get: () => import_operations.get,
  list: () => import_operations.list,
  stopAssignment: () => import_operations.stopAssignment,
  update: () => import_operations.update
});
module.exports = __toCommonJS(storageTaskAssignments_exports);
