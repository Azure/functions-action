...
export class FileServicesImpl {
    ...
    async *listServiceUsagesPagingPage(resourceGroupName, accountName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listServiceUsagesNext(resourceGroupName, accountName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listServiceUsagesPagingAll(resourceGroupName, accountName, options) {
        for await (const page of this.listServiceUsagesPagingPage(resourceGroupName, accountName, options)) {
            yield* page;
        }
    }
    /**
