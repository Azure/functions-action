...
export declare class BlobDownloadResponse implements Models.BlobDownloadResponse {
     ...
     * @memberof BlobDownloadResponse
     */
    readonly metadata: IMetadata | undefined;
    /**
     ...
     * @memberof BlobDownloadResponse
     */
    constructor(aborter: Aborter, originalResponse: Models.BlobDownloadResponse, getter: ReadableStreamGetter, offset: number, count: number, options?: IRetriableReadableStreamOptions);
}
