 ...
 * @extends {StorageURL}
 */
export declare class BlockBlobURL extends BlobURL {
    /**
     ...
     */
    static fromContainerURL(containerURL: ContainerURL, blobName: string): BlockBlobURL;
    /**
     ...
     * @memberof BlockBlobURL
     */
    static fromBlobURL(blobURL: BlobURL): BlockBlobURL;
    /**
     ...
     * @memberof BlockBlobURL
     */
    withPipeline(pipeline: Pipeline): BlockBlobURL;
    /**
     * Creates a new BlockBlobURL object identical to the source but with the
     ...
     * @memberof BlockBlobURL
     */
    withSnapshot(snapshot: string): BlockBlobURL;
    /**
     ...
     * @memberof BlockBlobURL
     */
    upload(aborter: Aborter, body: HttpRequestBody, contentLength: number, options?: IBlockBlobUploadOptions): Promise<Models.BlockBlobUploadResponse>;
    /**
     ...
     * @memberof BlockBlobURL
     */
    stageBlock(aborter: Aborter, blockId: string, body: HttpRequestBody, contentLength: number, options?: IBlockBlobStageBlockOptions): Promise<Models.BlockBlobStageBlockResponse>;
    /**
     ...
     * @memberof BlockBlobURL
     */
    stageBlockFromURL(aborter: Aborter, blockId: string, sourceURL: string, offset: number, count?: number, options?: IBlockBlobStageBlockFromURLOptions): Promise<Models.BlockBlobStageBlockFromURLResponse>;
    /**
     ...
     * @memberof BlockBlobURL
     */
    commitBlockList(aborter: Aborter, blocks: string[], options?: IBlockBlobCommitBlockListOptions): Promise<Models.BlockBlobCommitBlockListResponse>;
    /**
     ...
     * @memberof BlockBlobURL
     */
    getBlockList(aborter: Aborter, listType: Models.BlockListType, options?: IBlockBlobGetBlockListOptions): Promise<Models.BlockBlobGetBlockListResponse>;
}
//# sourceMappingURL=BlockBlobURL.d.ts.map