...
export declare type ServiceGetUserDelegationKeyResponse = UserDelegationKey & Models.ServiceGetUserDelegationKeyHeaders & {
    /**
...
export declare type ServiceSubmitBatchResponse = ParsedBatchResponse & Models.ServiceSubmitBatchHeaders & {
    /**
     * The underlying HTTP response.
     */
    _response: HttpResponse & {
 ...
 * @extends {StorageURL}
 */
export declare class ServiceURL extends StorageURL {
    /**
     ...
     * @memberof ServiceURL
     */
    withPipeline(pipeline: Pipeline): ServiceURL;
    /**
     ...
     * @memberof ServiceURL
     */
    getProperties(aborter: Aborter): Promise<Models.ServiceGetPropertiesResponse>;
    /**
     ...
     * @memberof ServiceURL
     */
    setProperties(aborter: Aborter, properties: Models.StorageServiceProperties): Promise<Models.ServiceSetPropertiesResponse>;
    /**
     ...
     * @memberof ServiceURL
     */
    getStatistics(aborter: Aborter): Promise<Models.ServiceGetStatisticsResponse>;
    /**
     ...
     * @memberof ServiceURL
     */
    getAccountInfo(aborter: Aborter): Promise<Models.ServiceGetAccountInfoResponse>;
    /**
     ...
     * @memberof ServiceURL
     */
    listContainersSegment(aborter: Aborter, marker?: string, options?: IServiceListContainersSegmentOptions): Promise<Models.ServiceListContainersSegmentResponse>;
    /**
     ...
     * @memberof ServiceURL
     */
    getUserDelegationKey(aborter: Aborter, start: Date, expiry: Date): Promise<ServiceGetUserDelegationKeyResponse>;
    /**
     ...
     * @memberof ServiceURL
     */
    submitBatch(aborter: Aborter, batchRequest: BatchRequest, options?: Models.ServiceSubmitBatchOptionalParams): Promise<ServiceSubmitBatchResponse>;
}
