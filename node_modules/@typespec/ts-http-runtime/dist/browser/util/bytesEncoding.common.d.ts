 ...
 * @internal
 */
export declare function utf8StringToUint8Array(value: string): Uint8Array<ArrayBuffer>;
/**
 * Encodes a Base64 string into a Uint8Array.
 * @internal
 */
export declare function base64ToUint8Array(value: string): Uint8Array<ArrayBuffer>;
/**
 * Encodes a Base64Url string into a Uint8Array.
 * @internal
 */
export declare function base64UrlToUint8Array(value: string): Uint8Array<ArrayBuffer>;
/**
 * Encodes a hex string into a Uint8Array
 * @internal
 */
export declare function hexStringToUint8Array(value: string): Uint8Array<ArrayBuffer>;
