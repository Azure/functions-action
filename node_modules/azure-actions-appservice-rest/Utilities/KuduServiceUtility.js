...
const GITHUB_ONE_DEPLOY = 'GITHUB_ONE_DEPLOY';
    ...
    deployUsingOneDeploy(packagePath, customMessage, targetPath, type, clean, restart) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var deploymentMessage = this._getUpdateHistoryRequest(null, null, customMessage).message;
                queryParameters.push('message=' + encodeURIComponent(deploymentMessage));
                let deploymentDetails = yield this._webAppKuduService.oneDeploy(packagePath, queryParameters);
    ...
    warmUp() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this._webAppKuduService.warmup();
