...
export const WebsiteEnableSyncUpdateSiteKey: string =
...
export class AzureAppService {
    ...
    public async get(
        force?: boolean
    ): Promise<AzureAppServiceConfigurationDetails> {
        ...
        try {
            ...
            var webRequest: WebRequest = {
                ...
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Web/sites/{name}/${slotUrl}/restart`,
                    {
    ...
    public async getPublishingProfileWithSecrets(
        force?: boolean
    ): Promise<any> {
        if (force || !this._appServicePublishingProfile) {
            this._appServicePublishingProfile =
                await this._getPublishingProfileWithSecrets();
        }
    ...
    public async getPublishingCredentials(): Promise<any> {
        try {
            var httpRequest: WebRequest = {
                method: "POST",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}/config/publishingcredentials/list`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
            ...
            throw Error(
                "Failed to fetch publishing credentials for app service " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async getSitePublishingCredentialPolicies(): Promise<any> {
        try {
            var httpRequest: WebRequest = {
                method: "GET",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}/basicPublishingCredentialsPolicies/scm`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
            ...
            throw Error(
                "Failed to get SitePublishingCredentialPolicies. " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async getApplicationSettings(
        ...
        if (force || !this._appServiceApplicationSetings) {
            this._appServiceApplicationSetings =
                await this._getApplicationSettings();
        }
    ...
    public async updateApplicationSettings(
        ...
        try {
            ...
            throw Error(
                "Failed to update application settings for app service " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async patchApplicationSettings(
        ...
        for (var key in addProperties) {
            if (applicationSettings.properties[key] != addProperties[key]) {
                core.debug(
                    `Value of ${key} has been changed to ${addProperties[key]}`
                );
        ...
        if (isNewValueUpdated) {
            applicationSettings.properties[WebsiteEnableSyncUpdateSiteKey] =
                this._isConsumptionApp ? "false" : "true";
        ...
        if (appSettingNames) {
            for (var key in addProperties) {
                if (addProperties[key].slotSetting == true) {
                    if (
                        appSettingNames.length == 0 ||
                        !appSettingNames.includes(addProperties[key].name)
                    ) {
                        appSettingNames.push(addProperties[key].name);
                    }
                    core.debug(
                        `Slot setting updated for key : ${addProperties[key].name}`
                    );
                    isNewValueUpdated = true;
                }
            }
    ...
    public async syncFunctionTriggersViaHostruntime(): Promise<any> {
        try {
            ...
            var httpRequest: WebRequest = {
                method: "POST",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}/hostruntime/admin/host/synctriggers`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
            ...
            while (true) {
                ...
                if (response.statusCode == 200) {
                    ...
                    if (++i < retryCount) {
                        ...
                        timeToWait =
                            timeToWait * retryIntervalInSeconds +
            ...
            throw Error(
                "Failed to sync triggers via host runtime for function app " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async getConfiguration(): Promise<AzureAppServiceConfigurationDetails> {
        try {
            var httpRequest: WebRequest = {
                method: "GET",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}/config/web`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
            ...
            throw Error(
                "Failed to get configuration settings for app service " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async updateConfiguration(
        ...
        try {
            ...
            throw Error(
                "Failed to update configuration settings for app service " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async patchConfiguration(properties: any): Promise<any> {
        try {
            ...
            throw Error(
                "Failed to patch configuration settings for app service " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async getSlotConfigurationNames(
        ...
        if (force || !this._appServiceConfigurationSettings) {
            this._appServiceConfigurationSettings =
                await this._getSlotConfigurationNames();
        }
    ...
    public async patchConnectionString(addProperties: any): Promise<boolean> {
        ...
        for (var key in addProperties) {
            if (
                JSON.stringify(connectionStringSettings.properties[key]) !=
                JSON.stringify(addProperties[key])
            ) {
                core.debug(
                    `Value of ${key} has been changed to ${JSON.stringify(
                        addProperties[key]
                    )}`
                );
                isNewValueUpdated = true;
    ...
    public async patchConnectionStringSlot(addProperties: any): Promise<any> {
        var connectionStringSlotSettings =
            await this.getSlotConfigurationNames();
        ...
        if (connectionStringNames) {
            for (var key in addProperties) {
                if (addProperties[key].slotSetting == true) {
                    if (
                        connectionStringNames.length == 0 ||
                        !connectionStringNames.includes(key)
                    ) {
    ...
    public async updateSlotConfigSettings(
        SlotConfigSettings: any
    ): Promise<AzureAppServiceConfigurationDetails> {
        try {
            var httpRequest: WebRequest = {
                method: "PUT",
    ...
    public async getMetadata(): Promise<AzureAppServiceConfigurationDetails> {
        try {
            var httpRequest: WebRequest = {
                method: "POST",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}/config/metadata/list`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
            ...
            throw Error(
                "Failed to get app service Meta data for " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    public async updateMetadata(
        ...
        try {
            var httpRequest: WebRequest = {
                ...
                body: JSON.stringify(applicationSettings),
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}/config/metadata`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
            ...
            throw Error(
                "Failed to update app serviceMeta data for " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    private async _getPublishingProfileWithSecrets(): Promise<any> {
        try {
            ...
            throw Error(
                "Failed to fetch publishing profile for app service " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    private async _getApplicationSettings(): Promise<AzureAppServiceConfigurationDetails> {
        try {
            var httpRequest: WebRequest = {
                method: "POST",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}/config/appsettings/list`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
            ...
            throw Error(
                "Failed to get application settings for app service " +
                    this._getFormattedName() +
                    ".\n" +
                    getFormattedError(error)
            );
    ...
    private async _getConnectionStrings(): Promise<AzureAppServiceConfigurationDetails> {
        try {
            ...
            var httpRequest: WebRequest = {
                method: "POST",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${slotUrl}/config/connectionstrings/list`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
    ...
    private async _get(): Promise<AzureAppServiceConfigurationDetails> {
        try {
            var httpRequest: WebRequest = {
                method: "GET",
                uri: this._client.getRequestUri(
                    `//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${this._slotUrl}`,
                    {
                        "{resourceGroupName}": this._resourceGroup,
                        "{name}": this._name,
                    },
